...
-- Coq: Lp2lc_coq\Active\Dsubsup.v:24-38
inductive typ : Type :=
  | top : typ
  | arr : typ → typ → typ
  | all : trm → typ → typ
...
-- Coq: Lp2lc_coq\Active\Dsubsup.v:40-58
...
-- Coq: Lp2lc_coq\Active\Dsubsup.v:160-166
inductive okt : env → Prop :=
  | okt_empty : okt []
  | okt_push : ∀ E x T, okt E → (x ∉ E.keys) → wft E T → okt ((x, T) :: E)

-- Coq: Lp2lc_coq\Active\Dsubsup.v:168-217
...
-- Coq: Lp2lc_coq\Active\Dsubsup.v:219-249
...
-- Coq: Lp2lc_coq\Active\Dsubsup.v:251-265
...
-- Coq: Lp2lc_coq\Active\Dsubsup.v:267-272
def preservation := ∀ e e' T, typing [] e T → red e e' → typing [] e' T

-- Coq: Lp2lc_coq\Active\Dsubsup.v:272-272
def progress := ∀ e T, typing [] e T → value e ∨ (∃ e', red e e')

-- Coq: Lp2lc_coq\Active\Dsubsup.v:286-306
...
-- Coq: Lp2lc_coq\Active\Dsubsup.v:308-326
