...
| subst_te_open_ee_var | subst_te_open_ee_var | no | opening/subst |
| subst_ee_open_te_var | subst_ee_open_te_var | no | opening/subst |
...
| wft_strengthen | wft_strengthen | no | wf |
...
| map_subst_tb_id | map_subst_tb_id | no | substitution |
...
| sub_strengthening | sub_strengthening | no | subtyping |
...
| typing_inv_tabs | typing_inv_tabs | no | typing |
| preservation_result | preservation_result | no | preservation |
| value_not_bot | value_not_bot | no | canonical forms |
| canonical_form_abs | canonical_form_abs | no | canonical forms |
| canonical_form_tabs | canonical_form_tabs | no | canonical forms |
