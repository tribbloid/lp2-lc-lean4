...
| wft_from_okt_typ | wft_from_okt_typ | no | wf |
| wft_from_okt_sub | wft_from_okt_sub | no | wf |
| wft_weaken_right | wft_weaken_right | no | wf |
| okt_push_inv | okt_push_inv | no | TBD |
| okt_push_sub_inv | okt_push_sub_inv | no | TBD |
| okt_push_sub_type | okt_push_sub_type | no | TBD |
| okt_push_typ_inv | okt_push_typ_inv | no | TBD |
| okt_push_typ_type | okt_push_typ_type | no | TBD |
| okt_narrow | okt_narrow | no | narrowing |
| okt_strengthen | okt_strengthen | no | TBD |
| okt_subst_tb | okt_subst_tb | no | substitution |
| okt_subst_tb_empty | okt_subst_tb_empty | no | substitution |
...
| value_not_bot | value_not_bot | no | values |
