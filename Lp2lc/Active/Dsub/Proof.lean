...
-- Substitution and opening on types/terms
...
-- Substitution through environment
/-- Coq: wf_subst -/ 
theorem wf_subst :
...
-- Weakening for sub/has and typing
