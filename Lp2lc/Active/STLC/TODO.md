...
- Require both final subagent reports: the assumption/capability audit must find no new abstract power, and the adversarial safety audit must fail to produce a counterexample.
