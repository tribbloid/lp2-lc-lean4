...
/-- [Coq L168-215] Subtyping & has (mutual) -/
mutual
...
/-- [Coq L285-293, 295-304] fv (mutual) -/
mutual
...
/-- [Coq L308-316, 318-326] substitution (mutual) -/
mutual
