...
- [ ] Separate or formally specify `AST.Val.compute` as a primitive-operation extension. A host function from `I.Data` to `Trm` is more expressive than the core simply typed lambda calculus.
