...
For each Coq source file, execute the following tasks sequentially. You should skip a task if it is already completed. If a task is partially completed, you should continue from where they left off:
...
#### 4. Verification
- Use `lake build` to verify that your code is imported, compiled, and correct.
