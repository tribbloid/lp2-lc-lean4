...
Proof.
  ...
  + discriminate.
  + case_if.
    - inversions Hhas. unfold label_for_def in *. destruct* d. discriminate.
    - apply* IHds.
Qed.
...
Proof.
  ...
  + discriminate.
  + case_if.
    - inversions Hhas. unfold label_for_dec in *. destruct* d. discriminate.
    - apply* IHds.
Qed.
...
Proof. 
  ...
  + unfold decs_has, get_dec in H. case_if; fold get_dec in H.
    - inversions H. unfold label_for_dec in *. simpl.
      case_if~.
    - simpl. destruct d as [|t' s'].
      * apply (IHDs2 n T1 S1 T2 S2). unfold decs_has. assumption.
      * case_if~. apply (IHDs2 n T1 S1 T2 S2). unfold decs_has. assumption.
Qed.
...
Hint Resolve wf_sto_to_ok_s wf_sto_to_ok_G : core.
