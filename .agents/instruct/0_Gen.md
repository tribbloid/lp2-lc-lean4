...
- For each Coq source: Reify the [prompt template](prompt/instruct/__Template.md) into a concrete prompts and save it
  into `prompt/instruct/<index_number>_<coq_source>.md`
